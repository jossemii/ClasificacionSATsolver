...
\begin{document}
	...
	\section{Introdución}
		...
		\subsection{Objetivos del proyecto}
			...
			A continuación expongo la arquitectura de servicios propuesta para SAT:
			\begin{itemize}
				...
				\item ServicesBalancer: Cuando el servicio local de un nodo recibe la solicitud para crear la instancia de un servicio, es este el que decide se creará en local o en algun nodo adyacente.
			\end{itemize}
	...
	\section{Problemas encontrados y decisiones técnicas}
