	...
	\section{Definición y desarrollo}
		...
		\subsection{Definición del sistema}
			...
			\begin{itemize}
				...
				\item El concepto implementación del nodo pretende remarcar aquellas decisiones sobre la lógica del nodo que son independientes del funcionamiento general de la red y, por tanto, otros nodos pueden no
					adoptar.
			\end{itemize}
