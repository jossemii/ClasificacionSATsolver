...
\begin{document}
	...
	\section{Evolución del trabajo}
		...
		\begin{itemize}
			...
			\item Comprobar, dando uso de solvers modificados para realizar la prueba, el correcto funcionamiento tanto de la 
				clasificación como de la regresión del modelo.
		\end{itemize}
		\\
		Sobre el balanceo de instancias y peticioens en el clasificador, se debe de tener en cuenta que:
		\begin{itemize}
		...
		de clientes, en los servicios distribuidos estos hilos se aislan (esto puede ser un punto negativo sobre el uso de memoria compartida) y se reparten entre los nodos de la red.
		\\
	...
	\section{Decisiones técnicas que se han tomado}
		\begin{itemize}
			\item Varias instancias no pueden compartir depencencias.
			\item Comunicación nodo-servicio.
			\item Serialización y topología de la especificación de un servicio.
			\item Json vs GRPC
		\end{itemize}
